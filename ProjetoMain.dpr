...
uses
  ...
  PagamentoDTO in 'Classes\Pagamento\PagamentoDTO.pas',
  PagamentoDAO in 'Classes\Pagamento\PagamentoDAO.pas',
  PagamentoAbstrato in 'Classes\Pagamento\PagamentoAbstrato.pas',
  uPesCategorias in 'ViewsPesquisa\uPesCategorias.pas' {FrmPesCategoria},
  uCadCategoria in 'ViewsCadastro\uCadCategoria.pas' {FrmCadCategoria},
  CategoriaDTO in 'Classes\Categoria\CategoriaDTO.pas',
  CategoriaDAO in 'Classes\Categoria\CategoriaDAO.pas';
