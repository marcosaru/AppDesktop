...
begin
  ...
  FornecedorDTO.Transportador    := TransportadorDAO.Encontrar(Edt_CodigoTransportador.Text);
  FornecedorDTO.Responsavel      := Edt_representante.Text;
...
begin
  ...
  Edt_representante.Text := '';
  Edt_CodigoTransportador.Text := '';
  Edt_Transportador.Text := '';
end;
