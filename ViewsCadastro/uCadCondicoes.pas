...
uses dmConexao, uPesFormPagto, uPesCondicoes;
...
begin
  try
    ...
    Condicoes    := CondicoesDAO.Encontrar(FrmPesCondicoes.QryPesquisaCON_CODIGO.AsString);
...
var
  ...
  Procedure checardescricao;
  begin
    if Length(Edt_Descricao.Text) < 3 then
    begin
      ShowMessage('É necessario estar no formato 000/...');
      Exit;
    end;
    Checar := true;
  end;
