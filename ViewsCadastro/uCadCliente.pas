...
begin
  ...
  if cto = 0 then
  begin
    ShowMessage('É necessario informar o celular para os relatórios.');
    exit;
  end;
  confirma;
end;
  ...
  begin
    try
      ...
      begin
       ...
       ShowMessage('Não foi possivel encontrar o bairro com este código, digite novamente.');
    finally
      BairroDTO.Free;
      BairroDAO.Free;
    end;
  ...
  begin
    try
      ...
      begin
       ...
       ShowMessage('Não foi possivel encontrar o municipio com este código, digite novamente.');
    finally
      BairroDTO.Free;
      BairroDAO.Free;
    end;
