...
interface
uses PagamentosMovimentoDTO, FireDAC.Comp.Client, System.SysUtils,MovimentoDTO;
...
type
  ...
  public
    ...
    function SalvarLista(Movimento:TMovimentoDTO):Boolean;
...
begin
  Qry.SQL.Clear;
  Qry.SQL.Add('SELECT * FROM COBRANCAS WHERE COB_CODIGO = :COB_CODIGO');
...
begin
  try
    ...
    Qry.ParamByName('COB_CODIGO').AsString := fdmConexao.retornaCodigoMaximo('COB_codigo','Cobrancas');
...
function TPagamentosMovimentoDAO.SalvarLista(Movimento: TMovimentoDTO): Boolean;
  var
