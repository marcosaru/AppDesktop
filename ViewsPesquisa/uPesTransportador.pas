...
begin
  try
    FrmCadTransportador := TFrmCadTransportador.Create(Self,ACodigo);
...
procedure TFrmPesTransportador.btnApresentarClick(Sender: TObject);
begin
  AbrirCadastro(3);
end;
...
procedure TFrmPesTransportador.FormShow(Sender: TObject);
begin
  Carregar;
end;

procedure TFrmPesTransportador.GridDblClick(Sender: TObject);
begin
  ModalResult := mrOk;
end;
