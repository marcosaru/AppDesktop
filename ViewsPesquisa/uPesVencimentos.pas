...
uses dmConexao, uPesCliente, uCadPagamento, uCadMovimento;
...
procedure TFrmPesVencimentos.btnApresentarClick(Sender: TObject);
begin
  Try
    FrmCadMovimento := TFrmCadMovimento.create(Self,5,QryPesquisaCOB_MOVIMENTO.AsString);
